...
const Skills = () => {
  ...
  return (
    <div id="experience" className="w-full py-16 text-white px-4 bg-[#1a1a1a] "
    >
      <div className="w-full mx-auto flex justify-center items-center mt-[-30px]">
        <h1 className="md:text-4xl sm:text-3xl text-xl text-[#2596be] font-bold mx-auto">
          Experience
        </h1>
      </div>
              ...
              <div className="md:w-4/6">
                ...
                <div className="mt-3">
                  {exp.skills.map((skill, skillIndex) => (
                    <div
                      key={skillIndex}
                      className="text-sm mr-2  md:mt-0 mt-2 border-2 border-[#2596be] text-gray-200 px-2 py-1 inline-block rounded-full"
                    >
                      {skill}
                    </div>
                  ))}
